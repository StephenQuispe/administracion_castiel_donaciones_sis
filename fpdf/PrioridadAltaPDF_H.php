...
class PDF extends FPDF
{
   ...
   function Header()
   {
     //include '../../recursos/Recurso_conexion_bd.php';//llamamos a la conexion BD
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE BENEFICIARIOS DE PRIORIDAD ALTA"), 0, 1, 'C', 0);
      $this->Ln(7);
...
$pdf->Output('PrioridadAlta.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
