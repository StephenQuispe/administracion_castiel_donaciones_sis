...
class PDF extends FPDF
{
   ...
   function Header()
   {
    ...
    //   $this->Cell(30, 10, utf8_decode('ZONA'), 1, 0, 'C', 1);
      ...
      $this->Cell(30, 10, utf8_decode('FECHA REGISTRO'), 1, 0, 'C', 1);
      $this->Cell(30, 10, utf8_decode('FRECUENCIA'), 1, 0, 'C', 1);
      $this->Cell(30, 10, utf8_decode('ORGANIZACION'), 1, 1, 'C', 1);
   }
...
while ($fila = $consulta->fetch_assoc()) {
    ...
    $pdf->Cell(30, 10, utf8_decode($fila["tipo"]), 1, 0, 'C', 0);
    $pdf->Cell(30, 10, utf8_decode($fila["fecha_registro"]), 1, 0, 'C', 0);
    $pdf->Cell(30, 10, utf8_decode($fila["frecuencia"]), 1, 0, 'C', 0);
    $pdf->Cell(30, 10, utf8_decode($fila["nombre_organizacion"]), 1, 1, 'C', 0);
}
$pdf->Output('Donantes.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
